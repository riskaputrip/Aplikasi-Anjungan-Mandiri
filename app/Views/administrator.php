    ...
    <div class="container pt-4">
      <div class="d-flex flex-column flex-md-row px-4 py-3 mb-4 bg-white rounded-2 shadow-sm">
        ...
        <div class="d-flex align-items-center me-md-auto">
          ...
          <h1 class="h5 pt-2" style="font-weight: bold;">Panggilan Antrian</h1>
        </div>
        <!-- breadcrumbs -->
      ...
      <div class="row">
        ...
        <div class="col-md-3 mb-4">
          <div class="card border-0 shadow-sm" style="background-color: #CCEDD2;">
            <div class="card-body p-4">
              <div class="d-flex justify-content-start">
                ...
                <div>
                  ...
                  <p class="mb-0" style="font-weight: bold;">Jumlah Antrian</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="col-md-3 mb-4">
          <div class="card border-0 shadow-sm" style="background-color: #C8D2FB;">
            <div class="card-body p-4">
              <div class="d-flex justify-content-start">
                <div class="feature-icon-3 me-4">
                ...
                <div>
                  ...
                  <p class="mb-0" style="font-weight: bold;">Antrian Sekarang</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="col-md-3 mb-4">
          <div class="card border-0 shadow-sm" style="background-color: #FACDCD;">
            <div class="card-body p-4">
              <div class="d-flex justify-content-start">
                <div class="feature-icon-3 me-4">
                ...
                <div>
                  ...
                  <p class="mb-0" style="font-weight: bold;">Antrian Selanjutnya</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="col-md-3 mb-4">
          <div class="card border-0 shadow-sm" style="background-color: #FFF591;">
            <div class="card-body p-4">
              <div class="d-flex justify-content-start">
                <div class="feature-icon-3 me-4">
                ...
                <div>
                  ...
                  <p class="mb-0" style="font-weight: bold;">Sisa <br> Antrian</p>
                </div>
              </div>
            </div>
          </div>
  ...
  <footer class="footer mt-auto py-4">
    <div class="container">
      ...
      <div class="copyright text-center mb-2 mb-md-0">
        &copy; 2022 - <a href="" target="_blank" class="text-danger text-decoration-none">Kementerian Kesehatan RI</a>. All rights reserved.
      </div>
    </div>
  </footer>
