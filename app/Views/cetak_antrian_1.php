...
<link href="<?php echo base_url('assets/user')?>/vendor/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
  ...
  <link href="<?php echo base_url('assets/user')?>/lib/themes/metroui.css" rel="stylesheet">
	  ...
	  <ul class="list-group list-group-flush">
	    <li class="list-group-item text-center"><h3>SELAMAT DATANG</h3><h5>Di Puskesmas Kecamatan Kebon Jeruk</h5>
	    	<h8>Jl. Raya Kb. Jeruk No.2, RW.1, Kb. Jeruk, Kec. Kb. Jeruk, Kota Jakarta Barat, Daerah Khusus Ibukota Jakarta 11510</h8>
		</li>
