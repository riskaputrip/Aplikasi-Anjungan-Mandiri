        ...
        <div class="row">
            <div class="col-md-7 py-8">
              <div class="container">
                  ...
                  <img src="/img/image3.png" alt="image 1" style="width:430px;height:268px;"> 
                </div>
            ...
            <div class="" id = "rcorners2" align="center">
              ...
              <a href="<?= base_url('peserta_bpjs')?>" class="btn btn-warning" >BPJS</a>
            </div>
              <style>
                           #rcorners2 {
            ...
            <div class="" id = "rcorners3" align="center">
              ...
              <a href="<?= base_url('peserta_nonbpjs')?>" class="btn btn-danger" >NON BPJS</a>
            </div>
              <style>
                           #rcorners3 {
                              border: solid black;
